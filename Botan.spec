...
Source0  : https://botan.randombit.net/releases/Botan-3.4.0.tar.xz
Source1  : https://botan.randombit.net/releases/Botan-3.4.0.tar.xz.asc
...
%setup -q -n Botan-3.4.0
cd %{_builddir}/Botan-3.4.0
%patch -P 1 -p1
%patch -P 2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727394520
...
/usr/lib64/cmake/Botan-3.4.0/botan-config-version.cmake
/usr/lib64/cmake/Botan-3.4.0/botan-config.cmake
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libbotan-3.so.4
/usr/lib64/libbotan-3.so.4.4.0
